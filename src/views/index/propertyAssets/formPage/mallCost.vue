    ...
    <section class="float-form-box">
        <div class="formDiscount">
          ...
          <section class="formBox">
              ...
              <my-el-input  class="input-box"
                                type="float"
                                v-model="barrieData.energyCost"></my-el-input>
          </section>
          <section class="formBox">
              <span>营销成本(元)</span>
              <my-el-input  class="input-box"
                                type="float"
                                v-model="barrieData.adCost"></my-el-input>
          </section>
          <section class="formBox">
              <span>商业管理成本(元)</span>
              <my-el-input  class="input-box"
                                type="float"
                                v-model="barrieData.businessManagementCost"></my-el-input>
          </section>
          <section class="formBox">
              <span>税费(元)</span>
              <my-el-input  class="input-box"
...
export default {
    ...
    methods: {
        checkHandle (item) {
          return !(item.maintainCost && item.hrCost && item.managementCost && item.energyCost && item.adCost && item.businessManagementCost && item.tax && item.totalCost)
        },
        checkMessage (item) {
